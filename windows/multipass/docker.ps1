...
pwsh -ExecutionPolicy Bypass ./launch.ps1 "${instance_name}" "2" "40G" "4G" "../../config/multipass/${instance_name}/${instance_name}.yaml" "22.04" "$local_workspace_dir" "$virtual_workspace_dir"
sleep 3
